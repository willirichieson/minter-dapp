const contractAddress = "0x91c2B67E8DCA444468998ceBdC2B2E17e503aCB6"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to the Lil Ape Planet NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Lil Ape Planet NFT Project is a going to the moon!!!';
